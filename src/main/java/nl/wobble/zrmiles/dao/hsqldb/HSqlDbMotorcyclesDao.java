 ...
 *
 * $Id: HSqlDbMotorcyclesDao.java,v 1.1 2007/06/01 15:24:06 rvk Exp $
 *
 * =============================================================================
 * Changelog:
 * -----------------------------------------------------------------------------
 ...
 * =============================================================================
 */
package nl.wobble.zrmiles.dao.hsqldb;
 ...
 * @author rvk
 */
public class HSqlDbMotorcyclesDao extends MotorcyclesDao {

    public HSqlDbMotorcyclesDao(
        String dbclass,
        String dburl,
        String dbuser,
        String dbpassword,
